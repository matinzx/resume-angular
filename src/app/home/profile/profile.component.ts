...
export class ProfileComponent implements OnInit, OnChanges  {
  ...
  public titleEnglish: string = "Who am I?";
  public subtitleEnglish: string = "Get to know me.";
  ...
  public profileEnglish: any =
    {
      title: 'SOME DESCRIPCTION:', data: '<p> Hi 👋!I am a devops engineer and full stack developer love to run Exercise is a priority I saw that I have to make the hard work easy for myself </p>',
